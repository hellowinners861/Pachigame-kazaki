...
const PACHI_LAYOUT = {
  ...
  board: { cx: 512, cy: 648, r: 397 },

  /* 玉が下に抜けるアウト開口(盤面円の最下部±この角度は壁なし) */
  outGap: 0.26,               // ラジアン

  /* スタートチャッカー(ヘソ): 盤面下中央の赤い円飾りに合わせる */
  start: { x: 510, y: 984, w: 48 },

  /* 風車: dir=1で時計回り */
  windmills: [
    { x: 312, y: 790, r: 16, dir: 1 },
    { x: 712, y: 790, r: 16, dir: -1 },
  ],

  /* 釘 [x, y] の配列 */
  pins: [
    // 天釘(上部で玉を散らす)
    [472, 370], [552, 370], [512, 420],
    // 寄り釘(上段スキャッタ)
    [392, 410], [632, 410],
    [352, 470], [432, 470], [592, 470], [672, 470],
    [312, 530], [392, 530], [472, 530], [552, 530], [632, 530], [712, 530],
    // サイドガイド(左)
    [227, 648], [242, 708], [262, 768], [287, 828], [317, 883],
    // サイドガイド(右)
    [797, 648], [782, 708], [762, 768], [737, 828], [707, 883],
    // 道釘(下段・金ビーズの点線アーチに沿わせて玉をヘソ方向へ誘導。外端は壁と接続)
    [232, 916], [262, 930], [291, 941], [320, 950], [349, 962], [378, 972], [406, 980], [434, 986], [462, 990],
    [792, 916], [762, 930], [733, 941], [700, 950], [671, 962], [642, 972], [614, 980], [586, 986], [558, 990],
    // 命釘(ヘソ口の両脇の2本。間隔で入賞率が変わる)
    [478, 984], [542, 984],
  ],
};
